...
function getMainCatList()
{
    ...
    $query = "SELECT c.name AS cat_name,s.name AS sub_name,p.* FROM pets AS p JOIN category AS c ON p.cat_id=c.id JOIN subcategory AS s ON p.sub_id=s.id WHERE p.status='Active' ORDER BY p.id DESC";
