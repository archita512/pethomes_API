...
function getMainCatList()
{
    ...
    $query = "SELECT c.name AS cat_name,p.name AS pet_catgeory,a.name,a.image,a.des,a.price,a.key,a.value FROM accessories AS a JOIN acce_catgeory AS c ON a.cat_id=c.id JOIN category AS p ON a.pet_cat=p.id WHERE a.pet_cat='$cat_id' AND a.status='Active'";
